...
const Experience: React.FC = () => {
  return (
    <div className="m-8">
      <h1 className="m-8 text-gray-600 text-5xl font-extrabold font-mono tracking-tighter">Experience</h1>
      <div>
        <ExperienceCards
        ...
        skills={["Git","HTML & CSS","JavaScript","TypeScript","React.js","Redux","Jest","Node.js","Express.js", "MongoDB","AWS"]}
        />
      </div>
    </div>
  );
